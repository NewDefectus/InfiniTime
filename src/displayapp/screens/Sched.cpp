...
namespace Pinetime { namespace Applications { namespace Screens {
  ...
  Schedule::Schedule()
    ...
    ::lv_label_set_long_mode(this->entry_what_label, ::LV_LABEL_LONG_BREAK);
    ::lv_obj_set_width(this->entry_what_label, LV_HOR_RES);
    ::lv_label_set_long_mode(this->entry_where_label, ::LV_LABEL_LONG_SROLL_CIRC);
    ::lv_obj_set_width(this->entry_where_label, LV_HOR_RES);
